...
/***/ function(module, exports, __webpack_require__) {
	...
	$container.html(_index2.default);
	...
	(0, _jquery2.default)(function () {
	    ...
	    $playButton.on('click', function () {
	        var _s = this;
	        (0, _jquery2.default)(_s).attr('src', 'images/pause.png');
	        ...
	        if (playStatus) {
	            playStatus = false;
	            (0, _jquery2.default)(_s).attr('src', 'images/play.png');
	            musicPlayer.pause();
	        } else {
	            playStatus = true;
	            musicPlayer.play();
	    ...
	    function step() {
	        ...
	        if (v == 2) {
	            ...
	            if (playProgres == downloadProgres) {
	                ...
	                var _tmp = willPlayDataDic['' + playProgres];
	                _tmp = DunzipA(_tmp);
	...
	function _getData(URL) {
	    _jquery2.default.get(URL).done(function (e) {
	...
	function DunzipA(str) {
	    var rx = /\leiA|\leiB|\leiC|\leiD|\leiE|\leiF|\leiG/g;
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./node_modules/.0.26.1@css-loader/index.js!./node_modules/.2.4.0@stylus-loader/index.js!./style.styl", function() {
				var newContent = require("!!./node_modules/.0.26.1@css-loader/index.js!./node_modules/.2.4.0@stylus-loader/index.js!./style.styl");
...
/***/ function(module, exports, __webpack_require__) {
	...
	buf.push("<div id=\"controlDiv\"><h3 id=\"controlDivTitle\">BadApple-播放控制</h3><p>有屏幕的地方就有BadApple</p></div><div class=\"screen\"><p id=\"play_window\" class=\"play-window\"></p></div><div class=\"buttonpanel\"><a class=\"btn\"> <img id=\"play_button\" src=\"images/play.png\"></a><a class=\"btn\"> <img id=\"stop_button\" src=\"images/stop.png\"></a></div><div class=\"cln\"><div id=\"progress\"><div id=\"downloadProgress\"></div><div id=\"playProgress\"></div></div><p id=\"downloadProgressText\" class=\"progress-text\">缓冲进度:0/6570 【0.00%】</p><p id=\"playProgressText\" class=\"progress-text\">播放进度:0/6570 【0.00%】</p></div><audio id=\"musicPlayer\" src=\"./BadAppleMp3/BadApple.mp3\"></audio>");;return buf.join("");
	}
